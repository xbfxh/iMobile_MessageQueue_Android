...
public class MultiMediaPopup extends PopupWindow implements OnClickListener {
    ...
    private String m_IPortalPassword = "bdpc123";// "supermap";

    // private String m_IServerURI = m_IPortalURI + "services";
    // private String m_IServerURI = "http://192.168.13.192:8091";
    ...
    private String serviceName = "data-mqdemo"; // iServer中的服务名
